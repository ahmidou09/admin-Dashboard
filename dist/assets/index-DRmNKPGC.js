...
`;function ut(){return e.jsxs(xt,{children:[e.jsxs("div",{className:"title",children:[e.jsx("h1",{children:"Products"}),e.jsx("button",{children:"Add Product"})]}),e.jsx(V,{data:X,columns:pt,renderItem:t=>e.jsx(ht,{product:t},t.id),itemLink:"users",itemPerPage:"8"})]})}const u=i.td`
  padding: 1.2rem 1.5rem;
`,U=i.button`
  margin: 0 0.5rem;
  padding: 0.5rem 1rem;
...
`;function bt(){return e.jsxs(jt,{children:[e.jsxs("div",{className:"title",children:[e.jsx("h1",{children:"Users"}),e.jsx("button",{children:"Add User"})]}),e.jsx(V,{data:j,columns:ft,renderItem:t=>e.jsx(vt,{user:t},t.id),itemPerPage:"8"})]})}function wt(){return e.jsx("div",{children:"Login"})}const yt=i.div`
  height: 100%;
  width: 100%;
  padding: 2rem 4rem;
